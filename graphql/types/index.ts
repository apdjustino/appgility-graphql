...
export type EventTrialResolvers<
    ContextType = CustomContext,
    ParentType extends ResolversParentTypes["EventTrial"] = ResolversParentTypes["EventTrial"],
> = ResolversObject<{
    id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = ResolversObject<{
    ...
    updateEvent?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationUpdateEventArgs, "eventId" | "updatedEvent" | "personId">
    >;
    ...
    updateEventTrial?: Resolver<
        Maybe<ResolversTypes["EventTrial"]>,
        ParentType,
        ContextType,
        RequireFields<MutationUpdateEventTrialArgs, "trialId" | "eventId" | "eventTrial">
    >;
    addRun?: Resolver<
        Maybe<ResolversTypes["Run"]>,
        ParentType,
        ContextType,
        RequireFields<MutationAddRunArgs, "eventId" | "trialId" | "personId" | "dogId" | "run">
    >;
    ...
    editRun?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationEditRunArgs, "eventId" | "trialId" | "runId" | "updatedRun">
    >;
...
export type PaginatedRunResponseResolvers<
    ContextType = CustomContext,
    ParentType extends ResolversParentTypes["PaginatedRunResponse"] = ResolversParentTypes["PaginatedRunResponse"],
> = ResolversObject<{
...
export type PersonRunResolvers<
    ContextType = CustomContext,
    ParentType extends ResolversParentTypes["PersonRun"] = ResolversParentTypes["PersonRun"],
> = ResolversObject<{
    id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    type?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type QueryResolvers<ContextType = CustomContext, ParentType extends ResolversParentTypes["Query"] = ResolversParentTypes["Query"]> = ResolversObject<{
    ...
    getPersonEvents?: Resolver<
        Maybe<Array<Maybe<ResolversTypes["PersonEvent"]>>>,
        ParentType,
        ContextType,
        RequireFields<QueryGetPersonEventsArgs, "personId">
    >;
    ...
    getTrialRunsPaginated?: Resolver<
        Maybe<ResolversTypes["PaginatedRunResponse"]>,
        ParentType,
        ContextType,
        RequireFields<QueryGetTrialRunsPaginatedArgs, "trialId">
    >;
}>;
...
export type RunViewResolvers<
    ContextType = CustomContext,
    ParentType extends ResolversParentTypes["RunView"] = ResolversParentTypes["RunView"],
> = ResolversObject<{
    id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    type?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    runId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type ScheduleRunResolvers<
    ContextType = CustomContext,
    ParentType extends ResolversParentTypes["ScheduleRun"] = ResolversParentTypes["ScheduleRun"],
> = ResolversObject<{
    id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    runId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    type?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
